...
class Page2 extends StatefulWidget {
  ...
  const Page2({
    ...
    required this.lat,
    required this.lon,
    required this.temp_in_c,
    required this.temp_in_f,
...
class _Page2State extends State<Page2> {
  ...
  Widget build(BuildContext context) {
    double temp_in_k =
        double.parse((widget.temp_in_c + 273.15).toStringAsPrecision(5));
    return Scaffold(
                ...
                child: SizedBox(
                  ...
                  child: OverflowBox(
                    ...
                    child: Opacity(
                        opacity: 0.4,
                        child: Lottie.asset(
                            'assets/animations/${getAnimation(widget.main_condition)}')),
                  ),
                ),
              ),
              Padding(
                ...
                child: Center(
                  ...
                  child: Row(
                    children: [
                      TempField(
                          temp_unit: '°Celsius',
                          temp_value: widget.temp_in_c.toString()),
                      TempField(
                          temp_unit: '°Fahrenheit',
                          temp_value: widget.temp_in_f.toString()),
                      TempField(
                          temp_unit: 'Kelvin',
                          temp_value: temp_in_k.toString()),
                    ],
                  ),
                )),
              ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Field(
                            ...
                            value: widget.pressure_mb.toString(),
                            fontsize: 25,
                          ),
                        ],
                      ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Field(
                                  ...
                                  value: getCoord(widget.lat, widget.lon),
                                  fontsize: 20,
                                ),
                              ],
                            ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Field(
                                  ...
                                  value: "${widget.wind_mph.toString()} km/hr",
                                  fontsize: 25,
                                ),
                              ],
                            ),
