...
//
//     final currentLocationResponseModel = currentLocationResponseModelFromJson(jsonString);

import 'dart:convert';

CurrentLocationResponseModel currentLocationResponseModelFromJson(String str) => CurrentLocationResponseModel.fromJson(json.decode(str));

String currentLocationResponseModelToJson(CurrentLocationResponseModel data) => json.encode(data.toJson());
...
class CurrentLocationResponseModel {
  ...
  factory CurrentLocationResponseModel.fromJson(Map<String, dynamic> json) => CurrentLocationResponseModel(
