...
//
//     final weeklyDataResponseModel = weeklyDataResponseModelFromJson(jsonString);

import 'dart:convert';

WeeklyDataResponseModel weeklyDataResponseModelFromJson(String str) => WeeklyDataResponseModel.fromJson(json.decode(str));

String weeklyDataResponseModelToJson(WeeklyDataResponseModel data) => json.encode(data.toJson());
...
class WeeklyDataResponseModel {
  ...
  factory WeeklyDataResponseModel.fromJson(Map<String, dynamic> json) => WeeklyDataResponseModel(
